...
class getTwigService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtension(new \App\Twig\Compos($f));
        $instance->addExtension(new \App\Twig\Composarabe($f));
        $instance->addExtension(new \App\Twig\Notes($f));
        $instance->addExtension(new \App\Twig\Notesarabe($f));
