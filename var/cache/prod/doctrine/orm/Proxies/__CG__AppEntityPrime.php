 ...
 */
class Prime extends \App\Entity\Prime implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'base' => [parent::class, 'base', null, 16],
        ...
        'base' => [parent::class, 'base', null, 16],
