...
/* produit/admin/index.html.twig */
class __TwigTemplate_6d5b6eb992c72f4e881a995647ebd146 extends Template
{
    ...
    {
        // line 8
        return $this->loadTemplate((($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) ? ("admin.html.twig") : ((($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_RH")) ? ("rh.html.twig") : ((($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_FINANCE")) ? ("finance.html.twig") : ((($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_STOCK")) ? ("stock.html.twig") : ((($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_LIVREUR")) ? ("livreur.html.twig") : ((($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_EMPLOYER")) ? ("employe.html.twig") : ("layout.html.twig")))))))))))), "produit/admin/index.html.twig", 8);
    }
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "produit/admin/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "produit/admin/index.html.twig"));
    ...
    <h3 class=\"mt-4 mb-5 text-bold\">
        ...
        ";
        // line 18
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Liste des Produits"), "html", null, true);
        yield "
    </h3>
    ";
        // line 20
    ...
    <table class=\"table table-success-light table-bordered table-hover table-striped w-100 text-center\" id=\"liste\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["produit"]) {
            ...
            yield "</td>
                <td class=\"text-left\">";
            // line 45
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "desigantion", [], "any", false, false, false, 45), "html", null, true);
            yield "</td>
                <td>";
            // line 46
            ...
            yield "</td>
                <td>";
            // line 47
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "prixpublic", [], "any", false, false, false, 47), "html", null, true);
            yield "</td>
                <td>";
            // line 48
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "mincommande", [], "any", false, false, false, 48), "html", null, true);
            yield "</td>
                <td class=\"text-left\">";
            // line 49
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "fabriquant", [], "any", false, false, false, 49), "html", null, true);
            yield "</td>
                <td class=\"text-nowrap\">
                    <a id=\"";
            // line 51
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "id", [], "any", false, false, false, 51), "html", null, true);
            yield "\" onclick=\"load(";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "id", [], "any", false, false, false, 51), "html", null, true);
            yield ")\" class=\"btn btn-success\" title=\"";
            ...
            yield "\" href=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("produit_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["produit"], "id", [], "any", false, false, false, 51)]), "html", null, true);
            yield "\">
                        <i class=\"fa fa-eye\"></i>
                    </a>
                </td>
...
";
    ...
    {
        return "produit/admin/index.html.twig";
    }
    ...
    {
        return array (  280 => 61,  271 => 58,  268 => 57,  266 => 56,  250 => 51,  245 => 49,  241 => 48,  237 => 47,  233 => 46,  229 => 45,  225 => 44,  222 => 43,  217 => 42,  210 => 38,  206 => 37,  200 => 36,  196 => 35,  192 => 34,  188 => 33,  184 => 32,  178 => 28,  169 => 25,  163 => 21,  159 => 20,  154 => 18,  149 => 15,  136 => 14,  113 => 12,  90 => 11,  65 => 10,  43 => 8,);
    }
...
{% endblock %}", "produit/admin/index.html.twig", "C:\\wamp\\www\\upgradegnt\\templates\\produit\\admin\\index.html.twig");
    }
}
