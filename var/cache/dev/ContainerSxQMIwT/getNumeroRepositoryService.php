 ...
 */
class getNumeroRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NumeroRepository' shared autowired service.
     *
     * @return \App\Repository\NumeroRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NumeroRepository.php';

        return $container->privates['App\\Repository\\NumeroRepository'] = new \App\Repository\NumeroRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
