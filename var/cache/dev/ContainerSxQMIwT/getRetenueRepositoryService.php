 ...
 */
class getRetenueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RetenueRepository' shared autowired service.
     *
     * @return \App\Repository\RetenueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RetenueRepository.php';

        return $container->privates['App\\Repository\\RetenueRepository'] = new \App\Repository\RetenueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
