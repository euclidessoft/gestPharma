 ...
 */
class getCongesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CongesRepository' shared autowired service.
     *
     * @return \App\Repository\CongesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CongesRepository.php';

        return $container->privates['App\\Repository\\CongesRepository'] = new \App\Repository\CongesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
