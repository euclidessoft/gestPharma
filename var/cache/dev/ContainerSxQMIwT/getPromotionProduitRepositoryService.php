 ...
 */
class getPromotionProduitRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PromotionProduitRepository' shared autowired service.
     *
     * @return \App\Repository\PromotionProduitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PromotionProduitRepository.php';

        return $container->privates['App\\Repository\\PromotionProduitRepository'] = new \App\Repository\PromotionProduitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
