 ...
 */
class getReponseAbsenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReponseAbsenceRepository' shared autowired service.
     *
     * @return \App\Repository\ReponseAbsenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReponseAbsenceRepository.php';

        return $container->privates['App\\Repository\\ReponseAbsenceRepository'] = new \App\Repository\ReponseAbsenceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
