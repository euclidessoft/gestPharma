 ...
 */
class getAvoirResteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AvoirResteRepository' shared autowired service.
     *
     * @return \App\Repository\AvoirResteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AvoirResteRepository.php';

        return $container->privates['App\\Repository\\AvoirResteRepository'] = new \App\Repository\AvoirResteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
