 ...
 */
class getLivrerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LivrerRepository' shared autowired service.
     *
     * @return \App\Repository\LivrerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LivrerRepository.php';

        return $container->privates['App\\Repository\\LivrerRepository'] = new \App\Repository\LivrerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
