 ...
 */
class getReponseExplicationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReponseExplicationRepository' shared autowired service.
     *
     * @return \App\Repository\ReponseExplicationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReponseExplicationRepository.php';

        return $container->privates['App\\Repository\\ReponseExplicationRepository'] = new \App\Repository\ReponseExplicationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
