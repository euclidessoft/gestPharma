 ...
 */
class getMessageReplyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessageReplyRepository' shared autowired service.
     *
     * @return \App\Repository\MessageReplyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessageReplyRepository.php';

        return $container->privates['App\\Repository\\MessageReplyRepository'] = new \App\Repository\MessageReplyRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
