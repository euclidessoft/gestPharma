 ...
 */
class getPrimePerformanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PrimePerformanceRepository' shared autowired service.
     *
     * @return \App\Repository\PrimePerformanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PrimePerformanceRepository.php';

        return $container->privates['App\\Repository\\PrimePerformanceRepository'] = new \App\Repository\PrimePerformanceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
