...
class getDepartementRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DepartementRepository.php';

        return $container->privates['App\\Repository\\DepartementRepository'] = new \App\Repository\DepartementRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
